...
.field private c:Landroid/support/v7/widget/gj;
...
.method private c(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/gj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->e:Landroid/support/v7/widget/gj;
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/gj;->c:Z

    iput-object v1, v0, Landroid/support/v7/widget/gj;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_2
    iget-boolean v1, v0, Landroid/support/v7/widget/gj;->d:Z

    if-nez v1, :cond_3

    iget-boolean v1, v0, Landroid/support/v7/widget/gj;->c:Z
    ...
    invoke-static {p1, v0, v1}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    iget-object v0, v0, Landroid/support/v7/widget/gj;->a:Landroid/content/res/ColorStateList;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    iput-object p1, v0, Landroid/support/v7/widget/gj;->a:Landroid/content/res/ColorStateList;

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/gj;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/gj;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object v0, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;

    const/4 v1, 0x1

    iput-boolean v1, v0, Landroid/support/v7/widget/gj;->c:Z
...
.method b()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroid/support/v7/widget/gj;->b:Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/gj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/gj;
...
.method c()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/am;->d:Landroid/support/v7/widget/gj;
    ...
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;[I)V
    ...
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/am;->c:Landroid/support/v7/widget/gj;
