...
.field private c:Landroid/support/v7/app/ae;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ae;
...
.method public a(Landroid/os/IBinder;)V
    ...
    invoke-direct {v1, v2}, Landroid/support/v7/app/af;-><init>(Landroid/content/Context;)V

    new-instance v2, Landroid/support/v7/view/menu/g;

    invoke-virtual {v1}, Landroid/support/v7/app/af;->a()Landroid/content/Context;
    ...
    invoke-virtual {v1, v2, p0}, Landroid/support/v7/app/af;->a(Landroid/widget/ListAdapter;Landroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/af;
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/af;->a(Landroid/view/View;)Landroid/support/v7/app/af;

    :goto_0
    invoke-virtual {v1, p0}, Landroid/support/v7/app/af;->a(Landroid/content/DialogInterface$OnKeyListener;)Landroid/support/v7/app/af;

    invoke-virtual {v1}, Landroid/support/v7/app/af;->b()Landroid/support/v7/app/ae;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ae;

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ae;

    invoke-virtual {v0, p0}, Landroid/support/v7/app/ae;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V

    iget-object v0, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ae;

    invoke-virtual {v0}, Landroid/support/v7/app/ae;->getWindow()Landroid/view/Window;
    ...
    invoke-virtual {v0}, Landroid/support/v7/app/ae;->show()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/app/af;->a(Landroid/graphics/drawable/Drawable;)Landroid/support/v7/app/af;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/app/af;->a(Ljava/lang/CharSequence;)Landroid/support/v7/app/af;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/l;->c:Landroid/support/v7/app/ae;

    invoke-virtual {v1}, Landroid/support/v7/app/ae;->getWindow()Landroid/view/Window;
