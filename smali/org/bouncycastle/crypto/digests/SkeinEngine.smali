...
.method static constructor <clinit>()V
    ...
    invoke-static {v4, v6, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState(II[J)V
    ...
    invoke-static {v4, v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState(II[J)V
    ...
    invoke-static {v4, v4, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState(II[J)V

    new-array v0, v3, [J

    fill-array-data v0, :array_4

    invoke-static {v2, v6, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState(II[J)V
    ...
    invoke-static {v2, v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initialState(II[J)V
...
.method private createInitialState()V
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->variantIdentifier(II)Ljava/lang/Integer;
    ...
    new-instance v2, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;
    ...
    invoke-direct {v2, v4, v5}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;-><init>(J)V

    invoke-virtual {v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Configuration;->getBytes()[B

    move-result-object v2

    invoke-direct {p0, v0, v2}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubiComplete(I[B)V
...
.method private initParams(Ljava/util/Hashtable;)V
    ...
    iput-object v1, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->key:[B
    ...
    invoke-direct {v5, v0, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;-><init>(I[B)V
    ...
    invoke-static {v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->sort([Lorg/bouncycastle/crypto/digests/SkeinEngine$Parameter;)V
...
.method private output(J[BII)V
    ...
    invoke-static {p1, p2, v2, v1}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->wordToBytes(J[BI)V
    ...
    invoke-virtual {v0, v2, v1, v4, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V

    iget-object v0, p0, Lorg/bouncycastle/crypto/digests/SkeinEngine;->ubi:Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;

    invoke-virtual {v0, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->doFinal([J)V
    ...
    invoke-static {v6, v7, p3, v5}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->wordToBytes(J[BI)V
    ...
    invoke-static {v6, v7, v2, v1}, Lorg/bouncycastle/crypto/engines/ThreefishEngine;->wordToBytes(J[BI)V
...
.method private ubiComplete(I[B)V
    ...
    invoke-virtual {v0, p2, v1, v2, v3}, Lorg/bouncycastle/crypto/digests/SkeinEngine$UBI;->update([BII[J)V
...
.method public doFinal([BI)I
    ...
    invoke-direct/range {v1 .. v6}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->output(J[BII)V
...
.method public init(Lorg/bouncycastle/crypto/params/SkeinParameters;)V
    ...
    invoke-direct {p0, v0}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->initParams(Ljava/util/Hashtable;)V
...
.method public update(B)V
    ...
    invoke-virtual {p0, v0, v2, v1}, Lorg/bouncycastle/crypto/digests/SkeinEngine;->update([BII)V
