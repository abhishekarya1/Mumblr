...
.field private l:Landroid/support/v7/widget/df;
...
.method public e()Landroid/support/v7/widget/df;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;
...
.method public f()Z
    ...
    new-instance v2, Landroid/support/v7/widget/df;
    ...
    invoke-direct {v2, v3, v4, v5, v6}, Landroid/support/v7/widget/df;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/df;->a(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    invoke-virtual {v2, p0}, Landroid/support/v7/widget/df;->a(Landroid/widget/AdapterView$OnItemClickListener;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    iget-object v3, p0, Landroid/support/v7/view/menu/v;->f:Landroid/support/v7/view/menu/w;

    invoke-virtual {v2, v3}, Landroid/support/v7/widget/df;->a(Landroid/widget/ListAdapter;)V

    iget-object v2, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/df;->a(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/df;->d(I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/df;->f(I)V

    iget-object v0, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;

    const/4 v2, 0x2

    invoke-virtual {v0, v2}, Landroid/support/v7/widget/df;->g(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/df;->m()Landroid/widget/ListView;
...
.method public onDismiss()V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/v;->l:Landroid/support/v7/widget/df;
