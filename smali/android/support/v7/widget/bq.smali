...
.field private d:Landroid/support/v7/widget/gj;

.field private e:Landroid/support/v7/widget/gj;

.field private f:Landroid/support/v7/widget/gj;

.field private g:Landroid/support/v7/widget/gj;
...
.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/ar;I)Landroid/support/v7/widget/gj;
    .locals 3
    ...
    iput-boolean v2, v0, Landroid/support/v7/widget/gj;->d:Z

    iput-object v1, v0, Landroid/support/v7/widget/gj;->a:Landroid/content/res/ColorStateList;
...
.method a()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/gj;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/gj;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/gj;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/gj;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/gj;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;)V

    const/4 v1, 0x1

    aget-object v1, v0, v1

    iget-object v2, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/gj;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/gj;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/gj;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/bq;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/ar;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/gj;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v4, v0, v6}, Landroid/support/v7/widget/bq;->a(Landroid/content/Context;Landroid/support/v7/widget/ar;I)Landroid/support/v7/widget/gj;

    move-result-object v6

    iput-object v6, p0, Landroid/support/v7/widget/bq;->d:Landroid/support/v7/widget/gj;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/bq;->e:Landroid/support/v7/widget/gj;
    ...
    iput-object v6, p0, Landroid/support/v7/widget/bq;->f:Landroid/support/v7/widget/gj;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/bq;->g:Landroid/support/v7/widget/gj;
