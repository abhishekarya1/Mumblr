...
.field private d:Landroid/support/design/widget/bk;

.field private final e:Landroid/view/accessibility/AccessibilityManager;

.field private final f:Landroid/support/design/widget/bp;
...
.method static synthetic a(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/bp;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->f:Landroid/support/design/widget/bp;
...
.method private b(I)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->f:Landroid/support/design/widget/bp;

    invoke-virtual {v0, v1, p1}, Landroid/support/design/widget/bn;->a(Landroid/support/design/widget/bp;I)V
...
.method private c(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ee;->c(F)Landroid/support/v4/view/ee;

    move-result-object v0

    sget-object v1, Landroid/support/design/widget/a;->b:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ee;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ee;
    ...
    invoke-direct {v1, p0, p1}, Landroid/support/design/widget/bi;-><init>(Landroid/support/design/widget/Snackbar;I)V
...
.method private d(I)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->d:Landroid/support/design/widget/bk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->d:Landroid/support/design/widget/bk;

    invoke-virtual {v0, p0, p1}, Landroid/support/design/widget/bk;->a(Landroid/support/design/widget/Snackbar;I)V
...
.method private e()V
    ...
    invoke-virtual {v0, p0}, Landroid/support/design/widget/bk;->a(Landroid/support/design/widget/Snackbar;)V
...
.method public a()Z
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/bn;->e(Landroid/support/design/widget/bp;)Z
...
.method final b()V
    ...
    invoke-virtual {v1, v2}, Landroid/support/design/widget/bj;->a(F)V

    const v2, 0x3f19999a    # 0.6f

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bj;->b(F)V

    const/4 v2, 0x0

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bj;->a(I)V

    new-instance v2, Landroid/support/design/widget/bc;

    invoke-direct {v2, p0}, Landroid/support/design/widget/bc;-><init>(Landroid/support/design/widget/Snackbar;)V

    invoke-virtual {v1, v2}, Landroid/support/design/widget/bj;->a(Landroid/support/design/widget/bv;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/Snackbar$SnackbarLayout;->setOnAttachStateChangeListener(Landroid/support/design/widget/bl;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/design/widget/Snackbar$SnackbarLayout;->setOnLayoutChangeListener(Landroid/support/design/widget/bm;)V
