...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v1}, Landroid/support/design/widget/CoordinatorLayout;->a(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroid/support/design/widget/q;

    move-result-object v1

    iput-object v1, p0, Landroid/support/design/widget/t;->a:Landroid/support/design/widget/q;
...
.method private a(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
    ...
    iput-object v3, p0, Landroid/support/design/widget/t;->h:Landroid/view/View;

    iput-object v3, p0, Landroid/support/design/widget/t;->g:Landroid/view/View;
...
.method a(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/t;->i:Landroid/graphics/Rect;
...
.method public a(Landroid/support/design/widget/q;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/t;->a:Landroid/support/design/widget/q;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, Landroid/support/design/widget/t;->a:Landroid/support/design/widget/q;

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/design/widget/t;->j:Ljava/lang/Object;
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
    ...
    :cond_0
    iget-boolean v1, p0, Landroid/support/design/widget/t;->k:Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/design/widget/q;->e(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {v0, p1, p2, p3}, Landroid/support/design/widget/q;->b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
...
.method public b()Landroid/support/design/widget/q;
    .locals 1
...
.method b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/view/View;
    ...
    invoke-direct {p0, p2, p1}, Landroid/support/design/widget/t;->b(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)Z
    ...
    :cond_1
    invoke-direct {p0, p2, p1}, Landroid/support/design/widget/t;->a(Landroid/view/View;Landroid/support/design/widget/CoordinatorLayout;)V
...
.method b(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/design/widget/t;->m:Z
...
.method i()Z
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/t;->m:Z
...
.method j()V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/t;->m:Z
