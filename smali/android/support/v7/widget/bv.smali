...
.method private i(Landroid/support/v7/widget/bu;)Landroid/support/v7/widget/fj;
    .locals 1
...
.method public a(Landroid/support/v7/widget/bu;)F
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bv;->i(Landroid/support/v7/widget/bu;)Landroid/support/v7/widget/fj;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v7/widget/fj;->c()F
...
.method a(Landroid/content/Context;IFFF)Landroid/support/v7/widget/fj;
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/fj;-><init>(Landroid/content/res/Resources;IFFF)V
...
.method public a()V
    ...
    sput-object v0, Landroid/support/v7/widget/fj;->c:Landroid/support/v7/widget/fk;
...
.method public a(Landroid/support/v7/widget/bu;F)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/fj;->a(F)V
...
.method public a(Landroid/support/v7/widget/bu;I)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/fj;->a(I)V
...
.method public a(Landroid/support/v7/widget/bu;Landroid/content/Context;IFFF)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/bv;->a(Landroid/content/Context;IFFF)Landroid/support/v7/widget/fj;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fj;->a(Z)V
...
.method public b(Landroid/support/v7/widget/bu;)F
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fj;->d()F
...
.method public b(Landroid/support/v7/widget/bu;F)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/fj;->c(F)V
...
.method public c(Landroid/support/v7/widget/bu;)F
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fj;->e()F
...
.method public c(Landroid/support/v7/widget/bu;F)V
    ...
    invoke-virtual {v0, p2}, Landroid/support/v7/widget/fj;->b(F)V
...
.method public d(Landroid/support/v7/widget/bu;)F
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fj;->a()F
...
.method public e(Landroid/support/v7/widget/bu;)F
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/fj;->b()F
...
.method public f(Landroid/support/v7/widget/bu;)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/fj;->a(Landroid/graphics/Rect;)V
