...
.method static a(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
    ...
    invoke-static {p0, p1}, Landroid/support/design/widget/z;->b(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
    ...
    :cond_0
    invoke-static {p0, p1}, Landroid/support/design/widget/z;->c(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
...
.method private static b(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
    ...
    sget-boolean v2, Landroid/support/design/widget/z;->b:Z
    ...
    sput-object v2, Landroid/support/design/widget/z;->a:Ljava/lang/reflect/Method;

    sget-object v2, Landroid/support/design/widget/z;->a:Ljava/lang/reflect/Method;
    ...
    :goto_0
    sput-boolean v0, Landroid/support/design/widget/z;->b:Z
...
.method private static c(Landroid/graphics/drawable/DrawableContainer;Landroid/graphics/drawable/Drawable$ConstantState;)Z
    ...
    sget-boolean v1, Landroid/support/design/widget/z;->d:Z
    ...
    sput-object v1, Landroid/support/design/widget/z;->c:Ljava/lang/reflect/Field;

    sget-object v1, Landroid/support/design/widget/z;->c:Ljava/lang/reflect/Field;
    ...
    :goto_0
    sput-boolean v0, Landroid/support/design/widget/z;->d:Z
