...
# instance fields
.field private a:Landroid/support/v4/widget/cf;
...
.field private final j:Landroid/support/v4/widget/ci;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/ci;
...
.method static synthetic a(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/design/widget/bv;
    .locals 1

    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/bv;
...
.method private a(Landroid/view/ViewGroup;)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/cf;
    ...
    iget-object v1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/ci;

    invoke-static {p1, v0, v1}, Landroid/support/v4/widget/cf;->a(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ci;)Landroid/support/v4/widget/cf;

    move-result-object v0

    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->a:Landroid/support/v4/widget/cf;

    :cond_0
    return-void

    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/SwipeDismissBehavior;->j:Landroid/support/v4/widget/ci;
...
.method static synthetic b(Landroid/support/design/widget/SwipeDismissBehavior;)Landroid/support/v4/widget/cf;
    .locals 1
...
.method public a(Landroid/support/design/widget/bv;)V
    ...
    iput-object p1, p0, Landroid/support/design/widget/SwipeDismissBehavior;->b:Landroid/support/design/widget/bv;
...
.method public b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v4/widget/cf;->b(Landroid/view/MotionEvent;)V
