...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;IILandroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p1, p2, v0, p3, v7}, Landroid/support/v7/widget/gl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/gl;
    ...
    invoke-static {v2, p2, v5, p3, v7}, Landroid/support/v7/widget/gl;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/gl;
    ...
    invoke-virtual {v2, v5, v6}, Landroid/support/v7/widget/gl;->f(II)I
    ...
    invoke-virtual {v2, v5}, Landroid/support/v7/widget/gl;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/widget/gl;->d(I)Ljava/lang/String;
    ...
    iput-object v2, p0, Landroid/support/v7/widget/bj;->g:Landroid/support/v7/widget/dk;

    :cond_2
    sget v0, Landroid/support/v7/a/l;->Spinner_android_entries:I

    invoke-virtual {v4, v0}, Landroid/support/v7/widget/gl;->e(I)[Ljava/lang/CharSequence;
    ...
    sget v5, Landroid/support/v7/a/i;->support_simple_spinner_dropdown_item:I
    ...
    :cond_3
    invoke-virtual {v4}, Landroid/support/v7/widget/gl;->a()V
    ...
    invoke-virtual {v4, v0, v7}, Landroid/support/v7/widget/gl;->g(II)I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bj;->g:Landroid/support/v7/widget/dk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bj;->g:Landroid/support/v7/widget/dk;

    invoke-virtual {v0, p0, p1}, Landroid/support/v7/widget/dk;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
