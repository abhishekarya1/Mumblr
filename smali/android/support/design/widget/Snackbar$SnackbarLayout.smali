...
.field private e:Landroid/support/design/widget/bm;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p0, v1}, Landroid/support/v4/view/bw;->d(Landroid/view/View;F)V
...
.method private static a(Landroid/view/View;II)V
    ...
    invoke-static {p0}, Landroid/support/v4/view/bw;->n(Landroid/view/View;)I

    move-result v1

    invoke-static {p0, v0, p1, v1, p2}, Landroid/support/v4/view/bw;->b(Landroid/view/View;IIII)V
...
.method a(II)V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ee;->b(J)Landroid/support/v4/view/ee;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bl;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bl;

    invoke-interface {v0, p0}, Landroid/support/design/widget/bl;->a(Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0, p0}, Landroid/support/design/widget/bl;->b(Landroid/view/View;)V
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v0, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bm;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/design/widget/bm;->a(Landroid/view/View;IIII)V
...
.method setOnAttachStateChangeListener(Landroid/support/design/widget/bl;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->f:Landroid/support/design/widget/bl;

    return-void
.end method

.method setOnLayoutChangeListener(Landroid/support/design/widget/bm;)V
    .locals 0

    iput-object p1, p0, Landroid/support/design/widget/Snackbar$SnackbarLayout;->e:Landroid/support/design/widget/bm;
