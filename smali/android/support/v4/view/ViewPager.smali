...
.field private static final ai:Landroid/support/v4/view/dw;
...
.field private R:Landroid/support/v4/widget/af;

.field private S:Landroid/support/v4/widget/af;
...
.field private ab:Landroid/support/v4/view/ds;

.field private ac:Landroid/support/v4/view/ds;

.field private ad:Landroid/support/v4/view/dr;

.field private ae:Landroid/support/v4/view/dt;
...
.field private o:Landroid/support/v4/view/du;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/ViewPager;->ai:Landroid/support/v4/view/dw;
...
.method private b(IFI)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/ds;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/ds;

    invoke-interface {v0, p1, p2, p3}, Landroid/support/v4/view/ds;->a(IFI)V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ac:Landroid/support/v4/view/ds;
...
.method private b(F)Z
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/af;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/af;->a(F)Z
    ...
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/af;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/widget/af;->a(F)Z
...
.method private d(I)Z
    ...
    :cond_0
    invoke-direct {p0}, Landroid/support/v4/view/ViewPager;->i()Landroid/support/v4/view/dp;
...
.method private e(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/ds;->a(I)V
...
.method private f(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/view/ds;->b(I)V
...
.method private g()V
    ...
    sget-object v1, Landroid/support/v4/view/ViewPager;->ai:Landroid/support/v4/view/dw;
...
.method private h()Z
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/af;

    invoke-virtual {v0}, Landroid/support/v4/widget/af;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/af;
...
.method private i()Landroid/support/v4/view/dp;
    .locals 13
...
.method private setScrollState(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->ae:Landroid/support/v4/view/dt;
...
.method a(I)V
    ...
    invoke-virtual {v4}, Landroid/support/v4/view/bo;->a()I
...
.method protected a(IFI)V
    ...
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->ae:Landroid/support/v4/view/dt;

    invoke-interface {v5, v3, v0}, Landroid/support/v4/view/dt;->a(Landroid/view/View;F)V
...
.method a(III)V
    ...
    invoke-virtual {v5, v7}, Landroid/support/v4/view/bo;->a(I)F
...
.method public addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    instance-of v3, p1, Landroid/support/v4/view/do;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/af;

    invoke-virtual {v4, v2, v3}, Landroid/support/v4/widget/af;->a(II)V

    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->R:Landroid/support/v4/widget/af;

    invoke-virtual {v2, p1}, Landroid/support/v4/widget/af;->a(Landroid/graphics/Canvas;)Z
    ...
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->S:Landroid/support/v4/widget/af;
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/af;->b()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v5, v4, Landroid/support/v4/view/dp;->b:I
...
.method public setAdapter(Landroid/support/v4/view/bo;)V
    ...
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/du;

    if-nez v1, :cond_2

    new-instance v1, Landroid/support/v4/view/du;

    invoke-direct {v1, p0, v5}, Landroid/support/v4/view/du;-><init>(Landroid/support/v4/view/ViewPager;Landroid/support/v4/view/dm;)V

    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/du;

    :cond_2
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->h:Landroid/support/v4/view/bo;

    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->o:Landroid/support/v4/view/du;
    ...
    :cond_3
    :goto_1
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/dr;
    ...
    invoke-interface {v1, v0, p1}, Landroid/support/v4/view/dr;->a(Landroid/support/v4/view/bo;Landroid/support/v4/view/bo;)V
...
.method setOnAdapterChangeListener(Landroid/support/v4/view/dr;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ad:Landroid/support/v4/view/dr;

    return-void
.end method

.method public setOnPageChangeListener(Landroid/support/v4/view/ds;)V
    .locals 0
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation

    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->ab:Landroid/support/v4/view/ds;
