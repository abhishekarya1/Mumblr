...
# static fields
.field static final a:Landroid/support/v7/widget/fs;
...
.field private q:Landroid/support/v7/widget/fu;

.field private r:Landroid/support/v7/widget/ft;

.field private s:Landroid/view/View$OnFocusChangeListener;

.field private t:Landroid/support/v7/widget/fv;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/fs;
...
.method private l()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/ge;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
    ...
    :cond_2
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/ge;->a(I)V
...
.method private m()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/fu;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/fu;->a(Ljava/lang/String;)Z
...
.method private o()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ft;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ft;

    invoke-interface {v0}, Landroid/support/v7/widget/ft;->a()Z
...
.method private q()V
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/fs;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fs;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/fs;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->c:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/fs;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method public clearFocus()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/cz;->clearFocus()V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-super {p0}, Landroid/support/v7/widget/cz;->onDetachedFromWindow()V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Landroid/support/v7/widget/cz;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Landroid/support/v7/widget/cz;->onSaveInstanceState()Landroid/os/Parcelable;
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-super {p0, p1}, Landroid/support/v7/widget/cz;->onWindowFocusChanged(Z)V
...
.method public requestFocus(ILandroid/graphics/Rect;)Z
    ...
    :cond_3
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/cz;->requestFocus(ILandroid/graphics/Rect;)Z
...
.method public setOnCloseListener(Landroid/support/v7/widget/ft;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->r:Landroid/support/v7/widget/ft;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/fu;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->q:Landroid/support/v7/widget/fu;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/fv;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/fv;
...
.method public setQueryRefinementEnabled(Z)V
    ...
    instance-of v0, v0, Landroid/support/v7/widget/ge;
