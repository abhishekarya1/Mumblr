...
.method protected handleHandshakeMessage(S[B)V
    ...
    invoke-virtual {v2, v0}, Lorg/bouncycastle/crypto/tls/RecordStream;->setPlaintextLimit(I)V
    ...
    invoke-static {v2, v3}, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->getPRFAlgorithm(Lorg/bouncycastle/crypto/tls/TlsContext;I)I
    ...
    invoke-interface {v3, v1}, Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;->getFinalHash(S)[B
    ...
    invoke-static {v2, v3, v1}, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->getCurrentPRFHash(Lorg/bouncycastle/crypto/tls/TlsContext;Lorg/bouncycastle/crypto/tls/TlsHandshakeHash;[B)[B
...
.method protected receiveServerHelloMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-virtual {v0, v3}, Lorg/bouncycastle/crypto/tls/ProtocolVersion;->equals(Ljava/lang/Object;)Z
    ...
    iput-short v5, v4, Lorg/bouncycastle/crypto/tls/SecurityParameters;->compressionAlgorithm:S
...
.method protected sendClientHelloMessage()V
    ...
    iput-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->offeredCipherSuites:[I
    ...
    iput-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->offeredCompressionMethods:[S
    ...
    iget-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->offeredCompressionMethods:[S
    ...
    invoke-interface {v4}, Lorg/bouncycastle/crypto/tls/TlsClient;->getClientExtensions()Ljava/util/Hashtable;

    move-result-object v4

    iput-object v4, p0, Lorg/bouncycastle/crypto/tls/TlsClientProtocol;->clientExtensions:Ljava/util/Hashtable;

    new-instance v4, Lorg/bouncycastle/crypto/tls/TlsProtocol$HandshakeMessage;

    invoke-direct {v4, p0, v1}, Lorg/bouncycastle/crypto/tls/TlsProtocol$HandshakeMessage;-><init>(Lorg/bouncycastle/crypto/tls/TlsProtocol;S)V

    invoke-static {v3, v4}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeVersion(Lorg/bouncycastle/crypto/tls/ProtocolVersion;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {v4, v3}, Lorg/bouncycastle/crypto/tls/TlsProtocol$HandshakeMessage;->write([B)V
    ...
    :cond_6
    invoke-virtual {v4}, Lorg/bouncycastle/crypto/tls/TlsProtocol$HandshakeMessage;->writeToRecordStream()V
