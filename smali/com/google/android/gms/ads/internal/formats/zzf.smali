...
.field private final zzyj:Landroid/support/v4/f/q;

.field private final zzyk:Landroid/support/v4/f/q;


# direct methods
.method public constructor <init>(Ljava/lang/String;Landroid/support/v4/f/q;Landroid/support/v4/f/q;Lcom/google/android/gms/ads/internal/formats/zza;)V
    .locals 1
    ...
    iput-object p2, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyj:Landroid/support/v4/f/q;

    iput-object p3, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/f/q;
...
.method public getAvailableAssetNames()Ljava/util/List;
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyj:Landroid/support/v4/f/q;

    invoke-virtual {v0}, Landroid/support/v4/f/q;->size()I

    move-result v0

    iget-object v1, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/f/q;

    invoke-virtual {v1}, Landroid/support/v4/f/q;->size()I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/f/q;->b(I)Ljava/lang/Object;
    ...
    :cond_0
    :goto_1
    iget-object v0, p0, Lcom/google/android/gms/ads/internal/formats/zzf;->zzyk:Landroid/support/v4/f/q;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/f/q;->b(I)Ljava/lang/Object;
