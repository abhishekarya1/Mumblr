...
.method protected handleHandshakeMessage(S[B)V
    ...
    :sswitch_0
    iget-short v2, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->connection_state:S
    ...
    :pswitch_0
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->receiveClientHelloMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    invoke-interface {v1}, Lorg/bouncycastle/crypto/tls/TlsServer;->getServerSupplementalData()Ljava/util/Vector;

    move-result-object v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->sendSupplementalDataMessage(Ljava/util/Vector;)V
    ...
    invoke-interface {v1}, Lorg/bouncycastle/crypto/tls/TlsServer;->getKeyExchange()Lorg/bouncycastle/crypto/tls/TlsKeyExchange;
    ...
    invoke-interface {v1, v2}, Lorg/bouncycastle/crypto/tls/TlsKeyExchange;->init(Lorg/bouncycastle/crypto/tls/TlsContext;)V

    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->tlsServer:Lorg/bouncycastle/crypto/tls/TlsServer;

    invoke-interface {v1}, Lorg/bouncycastle/crypto/tls/TlsServer;->getCredentials()Lorg/bouncycastle/crypto/tls/TlsCredentials;
    ...
    invoke-static {v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->readSupplementalDataMessage(Ljava/io/ByteArrayInputStream;)Ljava/util/Vector;
    ...
    invoke-interface {v2, v0}, Lorg/bouncycastle/crypto/tls/TlsServer;->processClientSupplementalData(Ljava/util/Vector;)V
    ...
    :cond_7
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->receiveCertificateMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    :goto_2
    :pswitch_6
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->receiveClientKeyExchangeMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    :cond_c
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->receiveCertificateVerifyMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    :cond_d
    :pswitch_9
    invoke-virtual {p0, v1}, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->processFinishedMessage(Ljava/io/ByteArrayInputStream;)V
...
.method protected receiveCertificateVerifyMessage(Ljava/io/ByteArrayInputStream;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->peerCertificate:Lorg/bouncycastle/crypto/tls/Certificate;
    ...
    iget-short v3, p0, Lorg/bouncycastle/crypto/tls/TlsServerProtocol;->clientCertificateType:S
    ...
    invoke-interface {v3, v4, v0, v2, v1}, Lorg/bouncycastle/crypto/tls/TlsSigner;->verifyRawSignature(Lorg/bouncycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/bouncycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    :try_end_0
