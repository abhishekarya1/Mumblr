...
.method a()V
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/bh;->d:Landroid/support/v4/b/l;
    ...
    iget-object v2, p0, Landroid/support/v4/app/bh;->b:Landroid/os/Bundle;

    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/bf;->a(ILandroid/os/Bundle;)Landroid/support/v4/b/l;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/bh;->d:Landroid/support/v4/b/l;
    ...
    iget-object v2, p0, Landroid/support/v4/app/bh;->d:Landroid/support/v4/b/l;
...
.method a(Landroid/support/v4/b/l;Ljava/lang/Object;)V
    ...
    invoke-static {v1}, Landroid/support/v4/app/bg;->a(Landroid/support/v4/app/bg;)Landroid/support/v4/app/af;
    ...
    invoke-static {v0}, Landroid/support/v4/app/bg;->a(Landroid/support/v4/app/bg;)Landroid/support/v4/app/af;

    move-result-object v0

    iget-object v0, v0, Landroid/support/v4/app/af;->d:Landroid/support/v4/app/ai;

    iget-object v0, v0, Landroid/support/v4/app/ai;->v:Ljava/lang/String;
    ...
    iget-object v1, v1, Landroid/support/v4/app/af;->d:Landroid/support/v4/app/ai;

    const-string v2, "onLoadFinished"

    iput-object v2, v1, Landroid/support/v4/app/ai;->v:Ljava/lang/String;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/bf;->a(Landroid/support/v4/b/l;Ljava/lang/Object;)V
    :try_end_0
    ...
    iput-object v1, v0, Landroid/support/v4/app/ai;->v:Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/support/v4/app/bg;->a(Landroid/support/v4/app/bg;)Landroid/support/v4/app/af;
    ...
    iget-object v2, v2, Landroid/support/v4/app/af;->d:Landroid/support/v4/app/ai;

    iput-object v1, v2, Landroid/support/v4/app/ai;->v:Ljava/lang/String;
...
.method b()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/bh;->i:Z
    ...
    iput-object v0, p0, Landroid/support/v4/app/bh;->c:Landroid/support/v4/app/bf;
...
.method c()V
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/bh;->e()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/bh;->g:Ljava/lang/Object;

    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/bh;->a(Landroid/support/v4/b/l;Ljava/lang/Object;)V
...
.method d()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/bh;->k:Z
...
.method f()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/app/bh;->l:Z

    iget-boolean v0, p0, Landroid/support/v4/app/bh;->f:Z

    iput-boolean v4, p0, Landroid/support/v4/app/bh;->f:Z

    iget-object v1, p0, Landroid/support/v4/app/bh;->c:Landroid/support/v4/app/bf;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v4/app/bh;->d:Landroid/support/v4/b/l;

    if-eqz v1, :cond_2

    iget-boolean v1, p0, Landroid/support/v4/app/bh;->e:Z
    ...
    iput-object v3, v1, Landroid/support/v4/app/ai;->v:Ljava/lang/String;
    ...
    iget-object v3, p0, Landroid/support/v4/app/bh;->d:Landroid/support/v4/b/l;

    invoke-interface {v0, v3}, Landroid/support/v4/app/bf;->a(Landroid/support/v4/b/l;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_2
    iput-object v2, p0, Landroid/support/v4/app/bh;->c:Landroid/support/v4/app/bf;

    iput-object v2, p0, Landroid/support/v4/app/bh;->g:Ljava/lang/Object;
