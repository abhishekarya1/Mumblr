...
# static fields
.field private static d:Landroid/support/v7/app/bp;
...
.method static a()Landroid/support/v7/app/bp;
    .locals 1

    sget-object v0, Landroid/support/v7/app/bp;->d:Landroid/support/v7/app/bp;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v7/app/bp;

    invoke-direct {v0}, Landroid/support/v7/app/bp;-><init>()V

    sput-object v0, Landroid/support/v7/app/bp;->d:Landroid/support/v7/app/bp;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/app/bp;->c:I

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/bp;->a:J

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/app/bp;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/app/bp;->a:J
    ...
    iget-wide v2, p0, Landroid/support/v7/app/bp;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/app/bp;->a:J
