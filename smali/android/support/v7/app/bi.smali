...
.field private final i:Landroid/support/v7/widget/gr;
...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/bi;->h:Ljava/lang/Runnable;
    ...
    iput-object v0, p0, Landroid/support/v7/app/bi;->i:Landroid/support/v7/widget/gr;

    new-instance v0, Landroid/support/v7/widget/gt;

    const/4 v1, 0x0

    invoke-direct {v0, p1, v1}, Landroid/support/v7/widget/gt;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/app/bi;->a:Landroid/support/v7/widget/cf;

    new-instance v0, Landroid/support/v7/app/bo;

    invoke-direct {v0, p0, p3}, Landroid/support/v7/app/bo;-><init>(Landroid/support/v7/app/bi;Landroid/view/Window$Callback;)V

    iput-object v0, p0, Landroid/support/v7/app/bi;->c:Landroid/view/Window$Callback;

    iget-object v0, p0, Landroid/support/v7/app/bi;->a:Landroid/support/v7/widget/cf;
    ...
    iget-object v0, p0, Landroid/support/v7/app/bi;->i:Landroid/support/v7/widget/gr;

    invoke-virtual {p1, v0}, Landroid/support/v7/widget/Toolbar;->setOnMenuItemClickListener(Landroid/support/v7/widget/gr;)V
...
.method static synthetic a(Landroid/support/v7/app/bi;Landroid/view/Menu;)Landroid/view/View;
    .locals 1

    invoke-direct {p0, p1}, Landroid/support/v7/app/bi;->a(Landroid/view/Menu;)Landroid/view/View;
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/app/bi;->b(Landroid/view/Menu;)V

    if-eqz p1, :cond_0

    iget-object v1, p0, Landroid/support/v7/app/bi;->g:Landroid/support/v7/view/menu/g;
    ...
    iget-object v0, p0, Landroid/support/v7/app/bi;->g:Landroid/support/v7/view/menu/g;

    iget-object v1, p0, Landroid/support/v7/app/bi;->a:Landroid/support/v7/widget/cf;
...
.method static synthetic a(Landroid/support/v7/app/bi;)Landroid/view/Window$Callback;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/app/bi;->c:Landroid/view/Window$Callback;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/app/bi;Z)Z
    .locals 0

    iput-boolean p1, p0, Landroid/support/v7/app/bi;->b:Z
...
.method private b(Landroid/view/Menu;)V
    ...
    iput-object v0, p0, Landroid/support/v7/app/bi;->g:Landroid/support/v7/view/menu/g;

    iget-object v0, p0, Landroid/support/v7/app/bi;->g:Landroid/support/v7/view/menu/g;

    new-instance v1, Landroid/support/v7/app/bn;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v7/app/bn;-><init>(Landroid/support/v7/app/bi;Landroid/support/v7/app/bj;)V
...
.method static synthetic b(Landroid/support/v7/app/bi;)Z
    .locals 1

    iget-boolean v0, p0, Landroid/support/v7/app/bi;->b:Z

    return v0
.end method

.method static synthetic c(Landroid/support/v7/app/bi;)Landroid/support/v7/widget/cf;
    .locals 1
...
.method private k()Landroid/view/Menu;
    ...
    invoke-direct {v1, p0, v3}, Landroid/support/v7/app/bl;-><init>(Landroid/support/v7/app/bi;Landroid/support/v7/app/bj;)V

    new-instance v2, Landroid/support/v7/app/bm;

    invoke-direct {v2, p0, v3}, Landroid/support/v7/app/bm;-><init>(Landroid/support/v7/app/bi;Landroid/support/v7/app/bj;)V
...
.method public a(I)V
    ...
    :goto_0
    invoke-interface {v1, v0}, Landroid/support/v7/widget/cf;->b(Ljava/lang/CharSequence;)V
...
.method public a(Z)V
    ...
    :goto_0
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/app/bi;->a(II)V
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    invoke-direct {p0}, Landroid/support/v7/app/bi;->k()Landroid/view/Menu;
...
.method public e()Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/bi;->h:Ljava/lang/Runnable;
